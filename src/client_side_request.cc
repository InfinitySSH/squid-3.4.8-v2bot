...
ClientHttpRequest::sslBumpStart()
{
    ...
    static const char *const conn_established = "HTTP/1.1 200 <font color='#9933FF'>✔️ Conectado ✔️ </font><font color='#1E90FF'>[v2] <strong>@InfinitySSHSmartBot - FREE</strong></font>\r\n\r\n";
